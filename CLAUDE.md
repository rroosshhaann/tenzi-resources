...
tenzi-resources/
  ...
  premium-samples/                        # Sample of premium paid reports
    ...
    gi-top20-monthly-headcount.html       # How the Top 20 changed each month (Dec 2025 → Jun 2026) — animated headcount bars, from the 21 Aug 2026 post; companion to the free Top 20 metric review (linked from the subtitle). Asset: top20_headcount_202512_202606_phone.gif (4.6 MB, 1080x1350, 79 frames, lazy-loaded) copied from python-scrapbook top20-analytics; thumb cut from the _phone_final.png frame. Names ARE allowed here (public Top 20 source, not the NIBA spike). Took the index row's second slot in Sep 2026 (premium_top20_monthly_click), pushing the incumbent-growth tile to the library
    insurance-news-top20-report.html       # Hub page for the Insurance News "Top 20 Authorised Rep Networks 2026" special report (24 Aug 2026, 40pp, sponsored by Arch Insurance; Tenzi = data + methodology). Not an analysis: what is inside (from the IN article), Get the report (IN's gated sign-up form, PREMIUM_insurance_news_report_click) + Read the article (PREMIUM_insurance_news_article_click) + About link, a Companion analytics card linking the six related pages, data notes, Book a call strip. Cover image insurance-news-top20-2026-cover.png (169x240 native, © Insurance News, pulled from their sign-up page header) shown at native size only; tile thumb is a crop of the Top 20 heatmap's rank/name/bars columns. Badge text "Partner" instead of "Sample". Took the index row's second slot in Sep 2026 (premium_insurance_news_click), pushing the emerging-networks tile to the library
...
| `(cta: PREMIUM_insurance_news_report_click)` / `(cta: PREMIUM_insurance_news_article_click)` | Outbound clicks from the Insurance News report hub page to the report sign-up form / the IN article |
